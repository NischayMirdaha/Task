...
import { Mail, Lock, User, ArrowRight, ScanText, AlertCircle, Loader2 } from 'lucide-react';
...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/auth/user/register', {
        username: name,
        email,
        password
      });
